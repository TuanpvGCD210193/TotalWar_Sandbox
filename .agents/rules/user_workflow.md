...
1. **Phong cách Đồng hành & Cầm tay chỉ việc (Educational Mentoring)**:
...
2. **Tuân thủ nghiêm ngặt SOLID & Phân tích Kiến trúc trước khi Code**:
...
3. **Quy trình Micro-Steps & Cập nhật tiến độ**:
...
4. **Hạn chế tối đa Hardcode (Asset Paths / Magic Values)**:
